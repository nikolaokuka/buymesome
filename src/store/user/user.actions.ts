...
export const setCurrentUser = withMatcher((user: UserData): SetCurrentUser => createAction(
...
export const signInFailed = withMatcher((error: Error): SignInFailed => createAction(
...
export const signUpSuccess = withMatcher((user: UserData, additionalDetails: AdditionalInformation): SignUpSuccess => createAction(
  USER_ACTION_TYPES.SIGN_UP_SUCCESS,
...
export const signOutFailed = withMatcher((error: Error): SignOutFailed => createAction(
